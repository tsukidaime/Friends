...
{
    public abstract class FriendsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FriendsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FriendsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FriendsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FriendsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FriendsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FriendsDbContext, Task<T>> func)
        {
            T result;
