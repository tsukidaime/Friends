...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Friends.Entities.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Friends.Entities.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Friends.Entities.UserEvent", b =>
                {
            ...
            modelBuilder.Entity("Friends.Entities.UserRoom", b =>
                {
                    b.Property<Guid>("RoomId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Friends.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Friends.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Friends.Entities.Event", b =>
                {
                    b.HasOne("Friends.Entities.Room", "Room")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Friends.Entities.UserEvent", b =>
                {
                    b.HasOne("Friends.Entities.Event", "Event")
                        .WithMany("UserEvents")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Friends.Authorization.Users.User", "User")
                        .WithMany("UserEvents")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
